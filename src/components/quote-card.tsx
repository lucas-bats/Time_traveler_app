...
export function QuoteCard({ id, quote, author, authorImage, className, disclaimerText }: QuoteCardProps) {
  return (
    <div
      id={id}
      className={cn(
        "relative w-[500px] p-8 rounded-2xl shadow-xl font-body flex flex-col justify-center items-center overflow-hidden",
        className
      )}
      style={{
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col grow justify-center items-center text-white w-full">
      ...
      {/* Disclaimer */}
      <div className="relative z-10 text-xs text-white/60 w-full text-center mt-auto pt-4">
        {disclaimerText}
      </div>
    </div>
  );
