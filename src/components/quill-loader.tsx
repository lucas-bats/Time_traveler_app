...
// Importa o hook de localização para obter o texto traduzido.
import { useLocale } from "@/lib/locale.tsx";

/**
 * Componente de loader que simula uma "pena de escrita".
 * Exibido enquanto a IA está processando uma resposta.
 */
      ...
      <div className="flex items-center space-x-2">
        ...
        >
          <path
            ...
            // A classe 'writing-animation' aplica a animação definida em globals.css.
        ...
        {/* Texto "Pensando..." que aparece ao lado da animação. */}
