...
const translations = {
  en: {
    ...
    details: 'Details',
    shareQuoteTitle: 'Share this Quote',
    shareQuoteDescription: 'Edit the quote below, then share it with your friends.',
    shareAction: 'Share',
    downloadAction: 'Download Image',
    generatingImageError: 'Could not generate the image.',
    quoteBy: 'Quote from {author}',
  ...
  pt: {
    ...
    shareQuoteDescription: 'Edite a citação abaixo e depois compartilhe com seus amigos.',
    shareAction: 'Compartilhar',
    downloadAction: 'Baixar Imagem',
    generatingImageError: 'Não foi possível gerar a imagem.',
