...
const translations = {
  en: {
    ...
    shareQuoteDescription: 'The text below will be turned into a stylized image for you to share.',
    shareAction: 'Share',
  ...
  pt: {
    ...
    shareQuoteDescription: 'O texto abaixo será transformado em uma imagem estilizada para você compartilhar.',
