...
const translations = {
  en: {
    ...
    shareQuoteDescription: "The text you edit below will be turned into a stylized image with the character's background for you to share.",
    shareAction: 'Share',
    downloadAction: 'Download',
    generatingImageError: 'Error generating image.',
    quoteBy: 'Quote by {author}',
    aiGeneratedBy: 'AI-generated by {appName}',
    religions: 'Religions',
    religionsSubtitle: 'Explore the history, teachings, and influential figures behind the world\'s great religions.',
    filterByReligion: 'Filter by Religion',
    allReligions: 'All Religions',
    noReligionsFound: 'No Religions Found',
    exploreReligion: 'Explore Religion',
  ...
  pt: {
    ...
    details: 'Detalhes',
    shareQuoteTitle: 'Compartilhar Citação',
    shareQuoteDescription: 'O texto que você editar abaixo será transformado em uma imagem estilizada com o fundo do personagem para você compartilhar.',
    shareAction: 'Compartilhar',
    downloadAction: 'Baixar',
    generatingImageError: 'Erro ao gerar a imagem.',
    quoteBy: 'Citação de {author}',
    aiGeneratedBy: 'IA-gerado por {appName}',
    religions: 'Religiões',
    religionsSubtitle: 'Explore a história, os ensinamentos e as figuras influentes por trás das grandes religiões do mundo.',
    filterByReligion: 'Filtrar por Religião',
    allReligions: 'Todas as Religiões',
    noReligionsFound: 'Nenhuma Religião Encontrada',
    exploreReligion: 'Explorar Religião',
